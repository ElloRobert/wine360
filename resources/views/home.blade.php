  ...
  <div class="row mt-45">
    <div class="col-md-6 col-right-margin">
        <div class="blok">
              <!-- Sadržaj prve kolone -->
              <div class="naslov">
                <img src="{{ asset('img/interface/kvacica.svg') }}" class="smanjena-slika">
              ...
              <div class="text-center mt-45">
                  <a class="btn btn-register" href="#"> 
                    {{ trans('default.activate') }} 
                    <img src="{{ asset('img/interface/aktivirajIkona.svg') }}" class="smanjena-slika">
                  </a>
              </div>
        </div>
    </div>
    <div class="col-md-6 col-right-margin">
      <div class="blok">
            <!-- Sadržaj prve kolone -->
            <div class="naslov">
              <img src="{{ asset('img/interface/autic.svg') }}" class="smanjena-slika">
              Dodajte novo vino!
            </div>
            <div class="text">
              Lorem ipsum dolor sit amet consectetur. Nunc eget tempus pharetra quis egestas. Etiam amet consequat commodo libero.
            ...
            <div class="text-center mt-45">
                <a class="btn btn-register" href="#"> {{ trans('default.addWine') }} </a>
            </div>
      </div>
    </div>
  </div>
