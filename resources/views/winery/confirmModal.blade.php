	...
	<div class="modal-dialog">
		<div class="modal-content model-content-delete">
			<div class="modal-header" style="border: none;">
				...
				<h3 class="modal-title model-title-delete">{{ trans('winery.deleteConfirmation') }}</h3>
			</div>
			<div class="modal-body">
				<div class="row marginTop tekst" style="display: flex; justify-content: center; align-items: center;">
					<p>{{ trans('winery.deleteConfirmationText') }}</p>
				</div>
					...
					<div class="row">
						<div class="col-md-2"></div>
							<form id="malfunction-delete-form" method="POST" action="">
								{{ csrf_field() }}
								{{ method_field('DELETE') }}
								<input style="float: right;" type="submit" class="btn  gumbObrisi" value="{{ trans('winery.delete') }}">
							</form>
						<div class="col-md-2"></div>
						<div class="col-md-2"></div>
					</div>
