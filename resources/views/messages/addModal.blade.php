                ...
                <div class="card text-center">
                    <div class="card-header mt-15">
                            <ul class="nav nav-pills card-header-pills">
                              ...
                              <li class="nav-item col liPoravnanje">
                                <a class="nav-link" href="#" id="zivotniVijek">Qr kod</a>
                              </li>
                        ...
                        <form method="POST" action="{{ route('wines.store') }}" enctype="multipart/form-data" >
                                ...
                                <div class="col-xs-12 col-sm-6 padding0">
                                    ...
                                    <div class="row">
                                        <div class="marginTop">
                                            ...
                                            <div class="col-xs-10 col-sm-10">
                                                <input class="form-control1 text-center" type="text" name="vintage_variety" id="wine-vintage-variety" value="{{ old('vintage_variety') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 padding0">
                                    ...
                                    <div class="row">
                                        <div class="marginTop">
                                            ...
                                            <div class="col-xs-10 col-sm-10">
                                                <input class="form-control1 text-center" type="text" name="country_of_origin" id="wine-country-of-origin" value="{{ old('country_of_origin') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div id="odrzavanjeInputi" class="d-none">
                                <div class="col-xs-12 col-sm-6 padding0">
                                    ...
                                    <div class="row">
                                        <div class="marginTop">
                                            <div class="col-xs-10 col-sm-10">
                                                <label class="control-label" for="wine-geographical-origin-labels">{{ trans('wines.geographical_origin_labels') }}</label>
                                            </div>
                                            <div class="col-xs-10 col-sm-10">
                                                <input class="form-control1 text-center" type="text" name="geographical_origin_labels" id="wine-geographical-origin-labels" value="{{ old('geographical_origin_labels') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div id="statusInputi" class="d-none">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <label for="wine-image-back">Slika vina (zadnja strana):</label>
