                                ...
                                <div class="col-xs-12 col-sm-6 padding0">
                                    <div class="row">
                                        <div class="marginTop">
                                            <div class="marginTop">
                                                ...
                                                <div class="col-xs-10 col-sm-10">
                                                    <input class="form-control1 text-center" type="text" name="name" id="message-name" value="{{ old('name') }}" disabled/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="marginTop">
                                            ...
                                            <div class="col-xs-10 col-sm-10">
                                                <input class="form-control1 text-center" type="email" name="email" id="message-email" value="{{ old('email') }}" disabled/>
                                            </div>
                                        </div>
                                    </div>
