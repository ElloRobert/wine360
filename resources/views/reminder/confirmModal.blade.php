		...
		<div class="modal-content model-content-delete">
			...
			<div class="modal-body">
				<div class="row marginTop tekst" style="display: flex; justify-content: center; align-items: center;">
					<p>{{ trans('reminder.deleteConfirmationText') }} <span class="remove-malfunction-name"></span>?</p>
				</div>
				<div style="display: flex; justify-content: center; align-items: center;">
					<div class="row">
						<div class="col-md-2"></div>
						<div class="col-md-2">
							<form id="malfunction-delete-form" method="POST" action="{{ route('reminders.index') }}">
								{{ csrf_field() }}
								{{ method_field('DELETE') }}
								<input style="float: right;" type="submit" class="btn  gumbObrisi" value="{{ trans('default.delete') }}">
							</form>
						</div>
						<div class="col-md-2"></div>
						<div class="col-md-3">
