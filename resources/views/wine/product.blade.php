...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 text-center">
          {{-- <img src="{{ asset('img/interface/korlatCaber.png') }}" alt="Vino" class="img-fluid my-auto"/> --}}
          <img src="{{ $frontImageUrl }}" alt="Prednja slika vina">
        </div>
        <div class="col-lg-6">
          <h1 class="display-4">{{$wine->name}}</h1>
          
          <ul>
            <li>Berba: {{$wine->harvest_year}}</li>
            <li>Vinogorje: {{$wine->geographical_origin_labels}}</li>
            <li>Sorta: {{$wine->vintage_variety}}</li>
            <li>Boja: </li>
            <li>Alkohol: {{$wine->alcohol_by_volume}}</li>
            <li>Vrsta: {{$wine->grape_variety_harvest_specific}}</li>
            <li>Pakiranje: {{$wine->net_quantity_ml}}mL</li>
            <li>Uvoznik, punionica i proizvođač: {{$wine->importer_bottler_manufacturer}}</li>
          </ul>
          <p class="font-weight-bold">Cijena: {{$wine->price}} €</p>
      ...
      <div class="row mt-5">
        <div class="col-lg-12">
          ...
          <ul>
            <li>Energija: {{$wine->nutrition_data}}mL</li>
            <li>Masti: 4,2 g</li>
            <li>Ugljikohidrati: {{$wine->sugar_content}}</li>
            <li>Proteini: 2,8 g</li>
            <li>Sol: 5,6 g</li>
            <li>Kiseline: </li>
            <li>Alergeni i intolerancije: {{$wine->allergen_declaration}}</li>
            <li>Serviranje: 1 čaša (150 ml)</li>
            <li>Način berbe: {{$wine->harvest_method}}</li>
            <li>Datum berbe: {{$wine->harvest_date}}</li>
            <li>Zemlja Porijekla: {{$wine->country_of_origin}}</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section class="recommended-products py-md-5">
    <div class="container">
      ...
      <div class="row">
        @foreach($wines as $recommendedProduct)
          <div class="col-lg-4 mb-4">
            <div class="card">
             ...
             @endphp
             <img src="{{$frontImageUrl}}" alt="Fotografija butelje">
              <div class="card-body">
                <h5 class="card-title">{{$recommendedProduct->name}}</h5>
                <p class="card-text">{{$recommendedProduct->product_description}}</p>
                <a href="/wines/product/{{ $recommendedProduct->id }}" class="btn btn-warning font-weight-bold">
                  Vidi više
                </a>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        <div class="explore-overlay">
          <img
            src=" {{ asset('img/interface/korlatNaslovna.jpg') }}"
          ...
          <div class="explore-text">
            ...
            <a href="/winery/product/{{$wine->configuration_id}}" class="btn btn-warning btn-lg font-weight-bold">
              Istraži
            </a>
          </div>
        </div>
