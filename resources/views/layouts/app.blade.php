...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('img/interface/logo.svg') }}">
    ...
    <!-- jPList core -->        
    <link href="{{ asset('css/jplist.core.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- Pagination Bundle -->          
    <link href="{{ asset('css/jplist.pagination-bundle.min.css') }}" rel="stylesheet" type="text/css" />
    
    <!-- Select2 -->
    <link rel="stylesheet" href="{{ asset('css/scripts/select2.min.css') }}" >
    <link rel="stylesheet" href="{{ asset('css/scripts/select2-bootstrap.min.css') }}">
    ...
    <script type="text/javascript" src="{{ url('js/cropit_src/jquery.cropit.js') }}" ></script>
    <script src="{{ asset('js/scripts/bootstrap.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('js/Wine360.js') }}"></script>
    <script type="text/javascript" src="{{ url('js/jeditable.js') }}"></script>

    <script src="{{ asset('js/jplist.core.min.js') }}"></script>
    <script src="{{ asset('js/jplist.pagination-bundle.min.js') }}"></script>
{{--    <script src="{{ asset('js/jplist.filter-toggle-bundle.min.js') }}"></script>--}}

    <script src="{{ asset('js/scripts/select2.full.min.js') }}"></script>

    <script src="{{ asset('js/scripts/jquery-ui.min.js') }}"></script>

    <script type="text/javascript" src="{{ url('js/datetimepicker.js') }}" ></script>
<!-- Data tabels treba zamjeniti da se ne povlaci s interneta nego da bude instalirano unutar projekta-->
    ...
    <link rel="stylesheet" href="{{ asset('css/scripts/jquery-ui-timepicker-addon.css') }}" />
    
    <link rel="stylesheet" href="{{ asset('css/scripts/jquery-ui.css') }}" />
...
var lang = "{{ data_get(Auth::user(), 'appLanguage', 'en') }}";
    ...
    <script type="text/javascript">
        ...
        jQuery('#edit-application-name span#editAppName').editable(function(value, settings) {
            ...
            callback: function(value, settings) {
                ...
                jQuery.ajax({
                    type: "POST",
                    url: '{{ url("configuration") }}/'+jQuery('#u').val()+'/name', {{-- route('configuration.name') --}}
                    data: {
                        name: value,
                        _token: CSRF_TOKEN
                    },
        ...
        }else if (link.match('wines')) {
            handleSubTabs(null, '#winesTab');
        } else if (link.match('reminders')) {
            handleSubTabs(null, '#remindersTab');
        }else if (link.match('winery')) {
            handleSubTabs(null, '#wineryTab');
        }else if (link.match('messages')) {
            handleSubTabs(null, '#messagesTab');
        } 
        else {
