		...
		<div class="modal-content model-content-delete">
			...
			<div class="modal-body">
				<div class="row marginTop tekst" style="display: flex; justify-content: center; align-items: center;">
					<p><?php echo e(trans('malfunction.deleteConfirmationText')); ?> <span class="remove-malfunction-name"></span>?</p>
				</div>
...
<?php /**PATH C:\Projekti\Wine360\resources\views/malfunction/confirmModal.blade.php ENDPATH**/ ?>