	...
	<div class="modal-dialog">
		<div class="modal-content model-content-delete">
			<div class="modal-header" style="border: none;">
				...
				<h3 class="modal-title model-title-delete"><?php echo e(trans('kilometers.deleteConfirmation')); ?></h3>
            </div>
			<div class="modal-body">
				<div class="row marginTop tekst" style="display: flex; justify-content: center; align-items: center;">
					<p><?php echo e(trans('kilometers.deleteConfirmationText')); ?> <span class="remove-malfunction-name"></span>?</p>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-2">
							<form id="malfunction-delete-form" method="POST" action="">
								...
								<input style="float: right;" type="submit" class="btn  gumbObrisi" value="<?php echo e(trans('kilometers.delete')); ?>">
							</form>
						</div>
						<div class="col-md-2"></div>
						<div class="col-md-3">
...
</div><?php /**PATH C:\Projekti\Wine360\resources\views/kilometers/confirmModal.blade.php ENDPATH**/ ?>