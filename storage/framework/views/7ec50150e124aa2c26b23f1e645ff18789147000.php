...
<div class="home-dashboard-content">
	<div class="row vehicles-home text-left mt-15">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="col-xs-5 padding0 naslov">
							<h1><?php echo e(trans('winery.title')); ?></h1>
						</div>	
		...
		<?php if(!Auth::user()->hasRole('employee')): ?>
			<?php echo $__env->make('winery.confirmModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			<?php echo $__env->make('winery.addModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php endif; ?>
	</div>
</div>
...
<script>
	function editWinery(winery_id) {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(route('winery.details')); ?>", 
			data: { 
				id: winery_id,
	...
	$(function() {
        ...
        $('#wineryTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                    url: '<?php echo e(route('getWineries')); ?>',
                    type: 'GET',
                    data: function (d) {
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projekti\wine360\resources\views/winery/index.blade.php ENDPATH**/ ?>