				...
				<div class="row">
					<div class="col-xs-12">
						<div class="col-xs-5 padding0 naslov">
							<h1><?php echo e(trans('message.title')); ?></h1>
						</div>	
...
<script>
	...
	$(function() {
        ...
        $('#winesTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                    url: '<?php echo e(route('getMessages')); ?>',
                    type: 'GET',
                    data: function (d) {
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projekti\wine360\resources\views/messages/index.blade.php ENDPATH**/ ?>