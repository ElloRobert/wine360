      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 text-light text-center about-text">
            ...
            <div class="lead parent">
              <?php echo $winery->winery_description; ?>
        ...
        <div class="row mt-5">
          <div class="col-lg-6 text-light text-center">
            ...
            <div class="lead parent">
              <?php echo $winery->wine_assortment; ?>
      ...
      <div class="container">
          ...
          <?php $__currentLoopData = $wines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 mb-4">
              <div class="card">
                ...
                ?>
                <img src="<?php echo e($frontImageUrl); ?>"  class="card-img-top" alt="Fotografija butelje">
                <div class="card-body">
        ...
        <div id="slider" class="carousel slide d-block d-sm-none" data-ride="carousel">
          <div class="carousel-inner">
            <?php $__currentLoopData = $wines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $wine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\Projekti\wine360\resources\views/winery/product.blade.php ENDPATH**/ ?>