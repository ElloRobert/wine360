		...
		<div class="modal-content model-content-delete">
			...
			<div class="modal-body">
				<div class="row marginTop tekst" style="display: flex; justify-content: center; align-items: center;">
					<p><?php echo e(trans('suppliers.deleteConfirmationText')); ?> <span class="remove-malfunction-name"></span>?</p>
				</div>
				<div style="display: flex; justify-content: center; align-items: center;">
					<div class="row">
						<div class="col-md-2"></div>
						<div class="col-md-2">
							<form id="malfunction-delete-form" method="POST" action="<?php echo e(route('users')); ?>">
								<?php echo e(csrf_field()); ?>

								<?php echo e(method_field('DELETE')); ?>

								<input style="float: right;" type="submit" class="btn  gumbObrisi" value="<?php echo e(trans('vehicles.delete')); ?>">
							</form>
						</div>
						<div class="col-md-2"></div>
						<div class="col-md-3">
...
</div><?php /**PATH C:\Projekti\wine360\resources\views/users/confirmModal.blade.php ENDPATH**/ ?>