...
<div class="home-dashboard-content">
	<div class="row vehicles-home text-left mt-15">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="col-xs-6 padding0 naslov">
							<h1><?php echo e(trans('vehiclesAdd.title')); ?></h1>
						</div>
						<!-- <div class="col-xs-3"> -->	
		...
		<?php if(!Auth::user()->hasRole('employee')): ?>
			<?php echo $__env->make('vehiclesAdd.addModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			<?php echo $__env->make('vehiclesAdd.confirmModal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php endif; ?>
	</div>
</div>
...
<script>
	...
	function editVehicle(vehicleId) {
		...
		$.ajax({
			...
			success: function(data) {
				var combinedString = data.name + " (" + data.license_plate + ")";
				$('#vehicle_id').val(data.id);

				$('#vehicles_name_license_plate').val(combinedString);
				
				console.log(data);
				var selectedDriverIds = data.drivers.map(driver => driver.id);
				// Postavljanje selektovanih vrednosti u select element
				$('#vehicles_driver').val(selectedDriverIds);
	...
	$(function() {
        ...
        $('#vehiclesTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                    url: '<?php echo e(route('getVehiclesAdd')); ?>',
                    type: 'GET',
                    data: function (d) {
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Projekti\wine360\resources\views/vehiclesAdd/index.blade.php ENDPATH**/ ?>