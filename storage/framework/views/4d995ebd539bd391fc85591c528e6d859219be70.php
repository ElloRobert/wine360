		...
		<div class="col-xs-12">
			...
			<div class="col-xs-12 col-md-6 mt-45">
				...
				<div class="col-xs-12 col-md-6 mt-45">
					...
					<div class="col-xs-10 col-sm-10">
						<label class="control-label" for="wineryDescription"><?php echo e(trans('configuration.wineryDescription')); ?></label>
					</div>
					<div class="col-xs-10 col-sm-10">
						<textarea class="form-control1" name="wineryDescription" id="wineryDescription" rows="5"><?php if (Auth::check() && Auth::user()->hasRole('employee')): ?><?php echo e(Auth::user()->legalEntityUser->configuration->wineryDescription); ?><?php endif; ?> <?php if (Auth::check() && Auth::user()->hasRole('admin|legal|private')): ?><?php echo e(Auth::user()->configuration->wineryDescription); ?><?php endif; ?></textarea>
					</div>
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 padding0">
					...
					<div class="col-xs-10 col-sm-10">
						<label class="control-label" for="innovations"><?php echo e(trans('configuration.innovations')); ?></label>
					</div>
					<div class="col-xs-10 col-sm-10">
						<textarea class="form-control1" name="innovations" id="innovations" rows="5"><?php if (Auth::check() && Auth::user()->hasRole('employee')): ?><?php echo e(Auth::user()->legalEntityUser->configuration->innovations); ?><?php endif; ?> <?php if (Auth::check() && Auth::user()->hasRole('admin|legal|private')): ?><?php echo e(Auth::user()->configuration->innovations); ?><?php endif; ?></textarea>
					</div>
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 padding0">
					...
					<div class="col-xs-10 col-sm-10">
						<label class="control-label" for="packaging"><?php echo e(trans('configuration.packaging')); ?></label>
					</div>
					<div class="col-xs-10 col-sm-10">
						<textarea class="form-control1" name="packaging" id="packaging" rows="5"><?php if (Auth::check() && Auth::user()->hasRole('employee')): ?><?php echo e(Auth::user()->legalEntityUser->configuration->packaging); ?><?php endif; ?> <?php if (Auth::check() && Auth::user()->hasRole('admin|legal|private')): ?><?php echo e(Auth::user()->configuration->packaging); ?><?php endif; ?></textarea>
					</div>
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 padding0">
					...
					<div class="col-xs-10 col-sm-10">
						<label class="control-label" for="wineAssortment"><?php echo e(trans('configuration.wineAssortment')); ?></label>
					</div>
					<div class="col-xs-10 col-sm-10">
						<textarea class="form-control1" name="wineAssortment" id="wineAssortment" rows="5"><?php if (Auth::check() && Auth::user()->hasRole('employee')): ?><?php echo e(Auth::user()->legalEntityUser->configuration->wine_assortment); ?><?php endif; ?> <?php if (Auth::check() && Auth::user()->hasRole('admin|legal|private')): ?><?php echo e(Auth::user()->configuration->wine_assortment); ?><?php endif; ?></textarea>
					</div>
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 padding0">
							<?php if($errors->has('wineAssortment')): ?>
								<span class="help-block text-center">
									<strong><?php echo e($errors->first('wineAssortment')); ?></strong>
								</span>
							<?php endif; ?>
						</div>
					</div>
					...
					<div class="col-xs-10 col-sm-10">
						<label class="control-label" for="awards"><?php echo e(trans('configuration.awards')); ?></label>
					</div>
					<div class="col-xs-10 col-sm-10">
						<textarea class="form-control1" name="awards" id="awards" rows="5"><?php if (Auth::check() && Auth::user()->hasRole('employee')): ?><?php echo e(Auth::user()->legalEntityUser->configuration->awards); ?><?php endif; ?> <?php if (Auth::check() && Auth::user()->hasRole('admin|legal|private')): ?><?php echo e(Auth::user()->configuration->awards); ?><?php endif; ?></textarea>
					</div>
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 padding0">
