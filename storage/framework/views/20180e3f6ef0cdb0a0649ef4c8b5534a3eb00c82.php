		...
		<div class="modal-content model-content-delete">
			...
			<div class="modal-body">
				<div class="row marginTop tekst" style="display: flex; justify-content: center; align-items: center;">
					<p><?php echo e(trans('fuel.delete')); ?> <span class="remove-malfunction-name"></span></p>
				</div>
...
</div><?php /**PATH C:\Projekti\Wine360\resources\views/fuel/confirmModal.blade.php ENDPATH**/ ?>